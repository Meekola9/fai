...
export const POSITION_OPTIONS: readonly PositionOption[] = [
  ...
  { value: 'OLB', group: 'LB', description: 'Outside linebacker' },
  {
    value: 'Star',
    group: 'LB',
    description: 'Fast, long overhang linebacker who can cover space, fit the run, and pressure',
    special: true,
  },
  ...
  },
  {
    value: 'Rover',
    group: 'DB',
    description: 'Big nickel defensive back / hybrid safety who plays in the box and space',
    special: true,
  },
