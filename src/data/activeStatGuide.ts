...
const POWER_CLEAN_GUIDE: readonly StatGuideEntry[] = [
  {
    ...
    interpretation: 'Higher is better within the athlete’s position group. A directly recorded max always overrides an estimate from the former body-weight repetition test.',
    caution: 'Power Clean performance is strongly influenced by Olympic-lift technique, catch quality, mobility, coaching standard, and testing confidence. It should not be treated as a direct measurement of blocking, tackling, or collision ability.',
    scoringNote: 'FAI scores the absolute clean max against position-group standards and averages that score with Broad Jump inside the Power category.',
    searchTerms: ['power clean', 'clean max', 'one rep max', '1rm', 'explosive strength'],
  },
  {
    ...
    interpretation: 'FAI converts the recorded body weight and repetitions into an estimated Power Clean 1RM using body weight × (1 + repetitions ÷ 30), rounded to the nearest five pounds.',
