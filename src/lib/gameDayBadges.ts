...
export const SEASON_ACHIEVEMENT_BADGES: readonly GameDayBadgeDefinition[] = [
  {
    key: 'achievement_workhorse_800',
    id: 'workhorse-800',
    name: 'Workhorse',
    tone: 'positive',
    scope: 'season',
    category: 'rushing',
    description: 'The runner supplied dependable production across the season.',
    earnedBy: 'Reach 800 rushing yards in one season.',
    priority: 86,
    art: { motif: 'rush', mark: '800' },
  },
  {
    key: 'achievement_four_digits',
    id: 'four-digits',
    name: 'Four Digits',
    tone: 'positive',
    scope: 'season',
    category: 'rushing',
    description: 'The runner crossed the premier four-digit rushing threshold.',
    earnedBy: 'Reach 1,000 rushing yards in one season.',
    priority: 94,
    art: { motif: 'rush', mark: '1K' },
  },
  {
    key: 'achievement_paydirt_10',
    id: 'paydirt-10',
    name: 'Paydirt 10',
    tone: 'positive',
    scope: 'season',
    category: 'rushing',
    description: 'The athlete became a consistent touchdown producer.',
    earnedBy: 'Score 10 total touchdowns in one season.',
    priority: 92,
    art: { motif: 'touchdown', mark: '10' },
  },
  {
    key: 'achievement_ground_monopoly',
    id: 'ground-monopoly',
    name: 'Ground Monopoly',
    tone: 'positive',
    scope: 'season',
    category: 'rushing',
    description: 'The runner controlled the goal line and repeatedly finished drives.',
    earnedBy: 'Score 15 rushing touchdowns in one season.',
    priority: 97,
    art: { motif: 'touchdown', mark: '15' },
  },
  {
    key: 'achievement_freight_train',
    id: 'freight-train',
    name: 'Freight Train',
    tone: 'positive',
    scope: 'season',
    category: 'rushing',
    description: 'The runner overwhelmed one opponent with a major workload and output.',
    earnedBy: 'Rush for 150 yards in one game.',
    priority: 88,
    art: { motif: 'rush', mark: '150' },
  },
  {
    key: 'achievement_touchdown_dealer',
    id: 'touchdown-dealer',
    name: 'Touchdown Dealer',
    tone: 'positive',
    scope: 'season',
    category: 'passing',
    description: 'The quarterback consistently generated passing scores.',
    earnedBy: 'Throw 10 passing touchdowns in one season.',
    priority: 88,
    art: { motif: 'pass', mark: '10' },
  },
  {
    key: 'achievement_air_traffic_control',
    id: 'air-traffic-control',
    name: 'Air Traffic Control',
    tone: 'positive',
    scope: 'season',
    category: 'passing',
    description: 'The quarterback directed a high-output touchdown passing attack.',
    earnedBy: 'Throw 20 passing touchdowns in one season.',
    priority: 97,
    art: { motif: 'pass', mark: '20' },
  },
  {
    key: 'achievement_two_grand',
    id: 'two-grand',
    name: 'Two Grand',
    tone: 'positive',
    scope: 'season',
    category: 'passing',
    description: 'The quarterback produced a major season through the air.',
    earnedBy: 'Reach 2,000 passing yards in one season.',
    priority: 92,
    art: { motif: 'pass', mark: '2K' },
  },
  {
    key: 'achievement_cannon_day',
    id: 'cannon-day',
    name: 'Cannon Day',
    tone: 'positive',
    scope: 'season',
    category: 'passing',
    description: 'The quarterback took over a game with passing volume and explosives.',
    earnedBy: 'Pass for 300 yards in one game.',
    priority: 89,
    art: { motif: 'pass', mark: '300' },
  },
  {
    key: 'achievement_surgeon',
    id: 'surgeon',
    name: 'Surgeon',
    tone: 'positive',
    scope: 'season',
    category: 'passing',
    description: 'The quarterback combined accuracy, decision-making, and ball security.',
    earnedBy: 'Complete at least 70% of 20 or more attempts with zero interceptions in one game.',
    priority: 93,
    art: { motif: 'precision', mark: '70' },
  },
  {
    key: 'achievement_target_magnet',
    id: 'target-magnet',
    name: 'Target Magnet',
    tone: 'positive',
    scope: 'season',
    category: 'receiving',
    description: 'The receiver became a dependable, frequently used option.',
    earnedBy: 'Record 40 receptions in one season.',
    priority: 86,
    art: { motif: 'target', mark: '40' },
  },
  {
    key: 'achievement_skyline',
    id: 'skyline',
    name: 'Skyline',
    tone: 'positive',
    scope: 'season',
    category: 'receiving',
    description: 'The receiver stacked major yardage throughout the season.',
    earnedBy: 'Reach 800 receiving yards in one season.',
    priority: 90,
    art: { motif: 'target', mark: '800' },
  },
  {
    key: 'achievement_air_property',
    id: 'air-property',
    name: 'Air Property',
    tone: 'positive',
    scope: 'season',
    category: 'receiving',
    description: 'The receiver owned a four-digit share of the passing game.',
    earnedBy: 'Reach 1,000 receiving yards in one season.',
    priority: 97,
    art: { motif: 'target', mark: '1K' },
  },
  {
    key: 'achievement_red_zone_royalty',
    id: 'red-zone-royalty',
    name: 'Red Zone Royalty',
    tone: 'positive',
    scope: 'season',
    category: 'receiving',
    description: 'The receiver repeatedly won scoring opportunities near the goal line.',
    earnedBy: 'Catch 10 receiving touchdowns in one season.',
    priority: 95,
    art: { motif: 'crown', mark: '10' },
  },
  {
    key: 'achievement_double_tap',
    id: 'double-tap',
    name: 'Double Tap',
    tone: 'positive',
    scope: 'season',
    category: 'receiving',
    description: 'The receiver struck the end zone multiple times in one game.',
    earnedBy: 'Catch two touchdowns in one game.',
    priority: 84,
    art: { motif: 'touchdown', mark: '2' },
  },
  {
    key: 'achievement_tackle_machine',
    id: 'tackle-machine',
    name: 'Tackle Machine',
    tone: 'positive',
    scope: 'season',
    category: 'defense',
    description: 'The defender consistently arrived and finished plays.',
    earnedBy: 'Record 75 tackles in one season.',
    priority: 88,
    art: { motif: 'tackle', mark: '75' },
  },
  {
    key: 'achievement_centurion',
    id: 'centurion',
    name: 'Centurion',
    tone: 'positive',
    scope: 'season',
    category: 'defense',
    description: 'The defender reached the elite century mark in total tackles.',
    earnedBy: 'Record 100 tackles in one season.',
    priority: 97,
    art: { motif: 'tackle', mark: '100' },
  },
  {
    key: 'achievement_backfield_tax',
    id: 'backfield-tax',
    name: 'Backfield Tax',
    tone: 'positive',
    scope: 'season',
    category: 'defense',
    description: 'The defender repeatedly charged offenses for entering the backfield.',
    earnedBy: 'Record 10 tackles for loss in one season.',
    priority: 91,
    art: { motif: 'backfield', mark: '10' },
  },
  {
    key: 'achievement_sack_lunch',
    id: 'sack-lunch',
    name: 'Sack Lunch',
    tone: 'positive',
    scope: 'season',
    category: 'defense',
    description: 'The pass rusher produced consistent quarterback disruption.',
    earnedBy: 'Record five sacks in one season.',
    priority: 88,
    art: { motif: 'sack', mark: '5' },
  },
  {
    key: 'achievement_wrecking_crew',
    id: 'wrecking-crew',
    name: 'Wrecking Crew',
    tone: 'positive',
    scope: 'season',
    category: 'defense',
    description: 'The pass rusher reached double-digit destruction in the pocket.',
    earnedBy: 'Record 10 sacks in one season.',
    priority: 98,
    art: { motif: 'sack', mark: '10' },
  },
  {
    key: 'achievement_no_fly_zone',
    id: 'no-fly-zone',
    name: 'No-Fly Zone',
    tone: 'positive',
    scope: 'season',
    category: 'defense',
    description: 'The defender repeatedly closed throwing windows and contested catches.',
    earnedBy: 'Record 10 pass breakups in one season.',
    priority: 91,
    art: { motif: 'coverage', mark: '10' },
  },
  {
    key: 'achievement_pickpocket',
    id: 'pickpocket',
    name: 'Pickpocket',
    tone: 'positive',
    scope: 'season',
    category: 'defense',
    description: 'The defender consistently stole possessions through the air.',
    earnedBy: 'Record five interceptions in one season.',
    priority: 96,
    art: { motif: 'takeaway', mark: '5' },
  },
  {
    key: 'achievement_ball_separator',
    id: 'ball-separator',
    name: 'Ball Separator',
    tone: 'positive',
    scope: 'season',
    category: 'defense',
    description: 'The defender repeatedly removed the football from ball carriers.',
    earnedBy: 'Force three fumbles in one season.',
    priority: 92,
    art: { motif: 'separate', mark: '3' },
  },
  {
    key: 'achievement_return_to_sender',
    id: 'return-to-sender',
    name: 'Return to Sender',
    tone: 'positive',
    scope: 'season',
    category: 'special-teams',
    description: 'The returner flipped the field all the way into the end zone.',
    earnedBy: 'Score a kickoff-return or punt-return touchdown.',
    priority: 94,
    art: { motif: 'return', mark: 'TD' },
  },
  {
    key: 'achievement_flip_the_field',
    id: 'flip-the-field',
    name: 'Flip the Field',
    tone: 'positive',
    scope: 'season',
    category: 'special-teams',
    description: 'The punter repeatedly pinned opponents in difficult field position.',
    earnedBy: 'Place five punts inside the opponent’s 20-yard line in one season.',
    priority: 87,
    art: { motif: 'kick', mark: '5' },
  },
  {
    key: 'achievement_touchback_king',
    id: 'touchback-king',
    name: 'Touchback King',
    tone: 'positive',
    scope: 'season',
    category: 'special-teams',
    description: 'The kickoff specialist consistently erased return opportunities.',
    earnedBy: 'Record 10 kickoff touchbacks in one season.',
    priority: 88,
    art: { motif: 'kick', mark: '10' },
  },
  {
    key: 'achievement_ice_water',
    id: 'ice-water',
    name: 'Ice Water',
    tone: 'positive',
    scope: 'season',
    category: 'special-teams',
    description: 'The kicker delivered when the result was on the line.',
    earnedBy: 'Make a game-winning field goal or extra point.',
    priority: 96,
    art: { motif: 'kick', mark: 'GW' },
  },
  {
    key: 'achievement_all_purpose_engine',
    id: 'all-purpose-engine',
    name: 'All-Purpose Engine',
    tone: 'positive',
    scope: 'season',
    category: 'versatility',
    description: 'The athlete generated production through multiple methods of gaining yards.',
    earnedBy: 'Reach 1,000 combined rushing, receiving, and return yards in one season.',
    priority: 94,
    art: { motif: 'versatile', mark: '1K' },
  },
  {
    key: 'achievement_swiss_army_score',
    id: 'swiss-army-score',
    name: 'Swiss Army Score',
    tone: 'positive',
    scope: 'season',
    category: 'versatility',
    description: 'The athlete found the end zone in multiple phases of the game.',
    earnedBy: 'Score touchdowns in two different phases: offense, defense, or special teams.',
    priority: 95,
    art: { motif: 'versatile', mark: '2X' },
  },
  {
    key: 'achievement_pancake_factory',
    id: 'pancake-factory',
    name: 'Pancake Factory',
    tone: 'positive',
    scope: 'season',
    category: 'offensive-line',
    description: 'The blocker repeatedly finished defenders on the ground.',
    earnedBy: 'Record 10 pancake blocks in one season.',
    priority: 91,
...
export const POSITIVE_GAME_DAY_BADGES = WEEKLY_BADGES.filter((badge) => badge.tone === 'positive')
